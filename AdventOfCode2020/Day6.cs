        ...
        public void Run() {
            ...
            foreach (var str in data) {
                if (str.Equals("")) {
                    ...
                    // Count up current group
                    for (int i = 0; i < charsSeen.Length; i++) {
                        if (charsSeen[i] == groupLines) {
                            Console.WriteLine($"Group {groups}: match on {(char)(i + 'a')}");
                            sum++;
                        }
                        charsSeen[i] = 0;
                    }
            ...
            Console.WriteLine($"Day 6: sum of counts = {sum}");
