...
namespace AdventOfCode2020 {
    public class Day4 : Day {
        ...
        private Criteria[] _criterias = {
            ...
            new Criteria() {
                ...
                validator = s => {
                    ...
                    if (s[s.Length - 2] == 'i' && s[s.Length - 1] == 'n') {
                        if (int.TryParse(s.Substring(0, 2), out var r)) {
                            return r >= 59 && r <= 76;
                        }
                    ...
                    if (s[s.Length - 2] == 'c' && s[s.Length - 1] == 'm') {
                        if (int.TryParse(s.Substring(0, 3), out var r)) {
                            return r >= 150 && r <= 193;
                        }
            ...
            new Criteria() {
                code = "ecl",
                validator = s => eyeColors.Contains(s),
            },
            new Criteria() {
                code = "pid",
                validator = s => {
        ...
        private class Passport {
            ...
            public Passport(Dictionary<string, string> values) {
                this.values = values;
            }
        }

        public void Run() {
            var passing = data.Count(IsValidPassportPartTwo);

            Console.WriteLine($"Day 4: {passing} valid passports");
        }

        private bool IsValidPassportPartOne(Passport passport) {
        ...
        private bool IsValidPassportPartTwo(Passport passport) {
            foreach (var criteria in _criterias) {
                if (passport.values.TryGetValue(criteria.code, out var r)) {
                    if (criteria.validator(r)) {
                        //Console.WriteLine($"{criteria.code} valid:\t{r}");
                    } else {
                        //Console.WriteLine($"{criteria.code} invalid:\t{r}");
                        return false;
                    }
                } else {
                    return false;
        ...
        private Passport[] data = {
            new Passport(new Dictionary<string, string> {
                {"eyr", "2024"}, {"pid", "662406624"}, {"hcl", "#cfa07d"}, {"byr", "1947"}, {"iyr", "2015"},
                {"ecl", "amb"},
                {"hgt", "150cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hcl", "#a97842"},
                {"eyr", "2026"}, {"byr", "1980"}, {"ecl", "grn"}, {"pid", "726519569"}, {"hgt", "184cm"},
                {"cid", "132"},
                {"iyr", "2011"},
            }),
            new Passport(new Dictionary<string, string> {
                {"ecl", "grn"}, {"hcl", "#6b5442"}, {"pid", "619743219"}, {"cid", "69"}, {"hgt", "176cm"},
                {"eyr", "2027"},
                {"iyr", "2012"},
                {"byr", "1980"},
            }),
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2023"}, {"ecl", "amb"}, {"iyr", "2020"}, {"byr", "1927"}, {"pid", "242570886"},
                {"hcl", "#18171d"},
                {"hgt", "192cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"pid", "154cm"}, {"hcl", "z"}, {"ecl", "gmt"}, {"iyr", "1989"}, {"hgt", "69in"}, {"cid", "53"},
                {"byr", "2010"},
            }),
            new Passport(new Dictionary<string, string> {
                {"hgt", "72cm"}, {"byr", "2023"},
            ...
            new Passport(new Dictionary<string, string> {
                {"iyr", "2020"}, {"eyr", "2021"}, {"byr", "1937"}, {"pid", "735047371"}, {"cid", "159"}, {"ecl", "blu"},
                {"hgt", "177cm"}, {"hcl", "#22b774"},
            }),
            new Passport(new Dictionary<string, string> {
                {"ecl", "brn"}, {"hcl", "#6b5442"}, {"pid", "117807698"}, {"cid", "105"}, {"iyr", "2016"},
                {"byr", "1977"},
                {"hgt", "183cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"byr", "1937"},
                {"iyr", "2016"}, {"ecl", "gry"}, {"hgt", "181cm"}, {"pid", "521705827"}, {"hcl", "#b6652a"},
                {"eyr", "2027"},
                {"cid", "295"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "oth"},
                {"hgt", "188cm"}, {"cid", "110"}, {"pid", "056975690"}, {"iyr", "2016"}, {"byr", "1950"},
                {"eyr", "2023"},
                {"hcl", "#cfa07d"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2028"},
                {"iyr", "2016"}, {"hcl", "#623a2f"}, {"pid", "208417572"}, {"byr", "1929"}, {"cid", "137"},
                {"ecl", "hzl"},
                {"hgt", "167cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "blu"}, {"hcl", "#508e8b"}, {"iyr", "2016"}, {"eyr", "1954"}, {"hgt", "151cm"},
                {"pid", "086752750"},
                {"byr", "1920"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"cid", "192"},
                {"byr", "1921"}, {"pid", "#5fe831"}, {"ecl", "#fbb2b9"}, {"hgt", "62cm"}, {"eyr", "1971"},
                {"iyr", "2024"},
                {"hcl", "z"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"byr", "2009"},
                {"eyr", "1985"}, {"pid", "484497014"}, {"ecl", "#0bfcf2"}, {"iyr", "1992"}, {"cid", "131"},
                {"hcl", "39d6b0"},
                {"hgt", "177in"},
            }),
            new Passport(new Dictionary<string, string> {
                {"eyr", "2020"}, {"iyr", "2016"}, {"ecl", "brn"}, {"hcl", "#ceb3a1"}, {"byr", "1966"},
                {"pid", "696621560"},
                {"cid", "62"},
                {"hgt", "59in"},
            }),
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "brn"}, {"hgt", "175cm"}, {"byr", "1992"}, {"iyr", "2016"}, {"pid", "415209726"},
                {"eyr", "2027"},
                {"cid", "72"}, {"hcl", "#866857"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2024"}, {"cid", "188"}, {"iyr", "2016"}, {"hcl", "ff3a59"}, {"ecl", "xry"},
                {"pid", "296357512"},
                {"byr", "2026"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"pid", "391011205"}, {"ecl", "hzl"}, {"hgt", "191cm"}, {"iyr", "2016"}, {"eyr", "2028"},
                {"cid", "281"},
                {"byr", "1934"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2023"}, {"hcl", "#efcc98"}, {"pid", "490625944"}, {"byr", "1961"}, {"ecl", "grn"},
                {"hgt", "155cm"},
                {"iyr", "2018"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hgt", "175cm"}, {"eyr", "1992"}, {"cid", "328"}, {"pid", "263110997"}, {"ecl", "#e53989"},
                {"byr", "2014"},
                {"hcl", "#a97842"}, {"iyr", "2026"},
            }),
            new Passport(new Dictionary<string, string> {
                {"pid", "491396731"}, {"eyr", "2027"}, {"hgt", "172cm"}, {"hcl", "#623a2f"}, {"cid", "92"},
                {"iyr", "2017"},
                {"byr", "1983"}, {"ecl", "grn"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2027"},
                {"hgt", "63in"}, {"ecl", "blu"}, {"byr", "1987"}, {"pid", "397963077"}, {"iyr", "2018"},
                {"hcl", "#ceb3a1"},
            }),
            new Passport(new Dictionary<string, string> {
                {"eyr", "2027"},
            ...
            new Passport(new Dictionary<string, string> {
                {"hgt", "190in"}, {"cid", "127"},
                {"byr", "1947"}, {"pid", "515728209"}, {"hcl", "#733820"}, {"iyr", "2014"}, {"ecl", "amb"},
                {"eyr", "2020"},
            }),
            new Passport(new Dictionary<string, string> {
                {"iyr", "2017"}, {"eyr", "2028"},
            ...
            new Passport(new Dictionary<string, string> {
                {"pid", "593398904"}, {"byr", "1939"}, {"iyr", "2019"}, {"hcl", "#b6652a"}, {"ecl", "gry"},
                {"eyr", "2023"},
                {"hgt", "70cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hcl", "z"},
                {"cid", "203"}, {"eyr", "2032"}, {"ecl", "#3f9d3d"}, {"hgt", "65cm"}, {"pid", "4042846885"},
                {"byr", "2019"},
                {"iyr", "1946"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "brn"}, {"hgt", "164cm"}, {"byr", "1969"}, {"hcl", "#cbf9c9"}, {"pid", "022724981"},
                {"eyr", "2030"},
                {"iyr", "2013"}, {"cid", "244"},
            }),
            new Passport(new Dictionary<string, string> {
                {"hgt", "162cm"}, {"byr", "1974"}, {"iyr", "2015"}, {"pid", "927525094"}, {"hcl", "#3d3011"},
                {"ecl", "blu"},
                {"eyr", "2023"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "#910bf2"}, {"byr", "1969"}, {"iyr", "2011"}, {"hcl", "z"}, {"eyr", "2024"},
                {"pid", "579502502"},
                {"cid", "103"}, {"hgt", "174cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2021"}, {"iyr", "2010"}, {"byr", "1942"}, {"hcl", "#7d3b0c"}, {"ecl", "hzl"},
                {"pid", "886241926"},
                {"hgt", "171cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hcl", "#c0946f"}, {"cid", "275"}, {"eyr", "1954"}, {"pid", "772184635"}, {"ecl", "#76add7"},
                {"byr", "2009"}, {"iyr", "2018"}, {"hgt", "151cm"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hgt", "172"}, {"hcl", "z"}, {"eyr", "1958"}, {"iyr", "1941"}, {"byr", "2019"}, {"pid", "389995951"},
                {"ecl", "dne"},
            }),
            new Passport(new Dictionary<string, string> {
                {"byr", "2025"}, {"hcl", "4c8dcd"},
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2029"}, {"pid", "837224515"}, {"ecl", "grn"}, {"cid", "231"}, {"hcl", "#733820"},
                {"iyr", "2019"},
                {"hgt", "159cm"},
                {"byr", "1977"},
            }),
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2027"}, {"iyr", "2019"}, {"cid", "328"}, {"byr", "1961"}, {"hcl", "#6b5442"}, {"ecl", "blu"},
                {"hgt", "177cm"}, {"pid", "235426720"},
            }),
            new Passport(new Dictionary<string, string> {
                {"byr", "1959"},
                {"eyr", "2025"},
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "hzl"}, {"cid", "340"}, {"pid", "086942161"}, {"byr", "1986"}, {"hcl", "#a97842"},
                {"iyr", "2018"},
                {"eyr", "2028"},
                {"hgt", "181cm"},
            }),
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2023"}, {"cid", "208"}, {"hgt", "178cm"}, {"hcl", "#341e13"}, {"byr", "1937"},
                {"pid", "290981079"},
                {"iyr", "2010"}, {"ecl", "grn"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"pid", "745674970"}, {"hgt", "160cm"}, {"eyr", "2021"}, {"byr", "1925"}, {"ecl", "gry"},
                {"hcl", "#341e13"},
                {"iyr", "2015"},
                {"cid", "297"},
            }),
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2030"}, {"pid", "#902a6b"}, {"iyr", "1997"}, {"hcl", "11f396"}, {"hgt", "188cm"},
                {"byr", "2025"},
                {"ecl", "dne"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "brn"},
                {"hcl", "#c0946f"}, {"iyr", "2030"}, {"pid", "264404022"}, {"byr", "1984"}, {"hgt", "59cm"},
                {"eyr", "2040"},
            }),
            new Passport(new Dictionary<string, string> {
                {"pid", "5973803069"},
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "amb"}, {"hcl", "#18171d"}, {"iyr", "2020"}, {"pid", "259501214"}, {"byr", "1978"},
                {"hgt", "193cm"},
                {"cid", "263"}, {"eyr", "2022"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hgt", "170cm"}, {"eyr", "2021"}, {"pid", "911638274"}, {"cid", "110"}, {"byr", "1963"},
                {"ecl", "blu"},
                {"iyr", "2015"}, {"hcl", "1eda64"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2027"}, {"pid", "221315043"}, {"iyr", "2010"}, {"hgt", "159cm"}, {"ecl", "blu"},
                {"byr", "1998"},
                {"hcl", "#6b5442"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "grn"}, {"hgt", "164cm"}, {"byr", "1951"}, {"hcl", "#18171d"}, {"cid", "75"},
                {"pid", "845508281"},
                {"eyr", "2021"}, {"iyr", "2017"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"iyr", "2016"}, {"hgt", "152cm"}, {"pid", "886247173"}, {"byr", "1940"}, {"hcl", "#c0946f"},
                {"eyr", "2027"},
                {"ecl", "oth"}, {"cid", "150"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "grn"}, {"iyr", "2014"}, {"cid", "250"}, {"hcl", "#b6652a"}, {"byr", "1970"},
                {"pid", "675238417"},
                {"hgt", "162cm"},
                {"eyr", "2026"},
            }),
            new Passport(new Dictionary<string, string> {
                {"ecl", "brn"},
                {"hcl", "#623a2f"}, {"eyr", "2021"}, {"pid", "293293433"}, {"hgt", "158"}, {"byr", "1977"},
                {"iyr", "2019"},
            }),
            new Passport(new Dictionary<string, string> {
                {"ecl", "oth"}, {"hcl", "#ceb3a1"}, {"pid", "013111996"}, {"eyr", "2023"}, {"hgt", "180cm"},
                {"byr", "1976"},
                {"cid", "224"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"hgt", "182cm"}, {"iyr", "2018"}, {"ecl", "hzl"}, {"eyr", "2029"}, {"byr", "1946"},
                {"pid", "602345030"},
                {"hcl", "#ceb3a1"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"byr", "2017"}, {"pid", "456780590"}, {"hcl", "#888785"}, {"eyr", "1966"}, {"ecl", "amb"},
                {"iyr", "2023"},
                {"cid", "187"}, {"hgt", "62cm"},
            }),
            new Passport(new Dictionary<string, string> {
                {"ecl", "hzl"}, {"iyr", "2015"}, {"hcl", "#6b5442"}, {"hgt", "152cm"}, {"eyr", "2028"}, {"byr", "1982"},
                {"pid", "003269467"},
            }),
            new Passport(new Dictionary<string, string> {
                {"iyr", "2017"}, {"eyr", "2026"},
            ...
            new Passport(new Dictionary<string, string> {
                {"hcl", "#fffffd"}, {"cid", "277"}, {"pid", "102326370"}, {"hgt", "154cm"}, {"eyr", "2026"},
                {"iyr", "2012"},
                {"byr", "1968"},
                {"ecl", "hzl"},
            }),
            new Passport(new Dictionary<string, string> {
                {"ecl", "oth"}, {"pid", "477189554"}, {"hcl", "#6b5442"}, {"eyr", "2022"}, {"byr", "1948"},
                {"hgt", "74in"},
                {"cid", "181"},
                {"iyr", "2016"},
            }),
            ...
            new Passport(new Dictionary<string, string> {
                {"ecl", "amb"}, {"pid", "5739190196"}, {"eyr", "2021"}, {"hgt", "157in"}, {"hcl", "#efcc98"},
                {"byr", "2018"},
                {"iyr", "2028"},
            }),
            new Passport(new Dictionary<string, string> {
            ...
            new Passport(new Dictionary<string, string> {
                {"iyr", "2020"}, {"byr", "1974"}, {"hgt", "163cm"}, {"ecl", "blu"}, {"hcl", "#7d3b0c"}, {"eyr", "2028"},
                {"cid", "99"},
            }),
            new Passport(new Dictionary<string, string> {
                {"hcl", "#a97842"},
            ...
            new Passport(new Dictionary<string, string> {
                {"eyr", "2028"}, {"hcl", "#ceb3a1"},
                {"hgt", "191cm"}, {"iyr", "2019"}, {"pid", "737842199"}, {"ecl", "blu"}, {"cid", "268"},
                {"byr", "1925"},
            }),
            new Passport(new Dictionary<string, string> {
                {"pid", "868397851"},
            ...
            new Passport(new Dictionary<string, string> {
                {"byr", "1921"}, {"hcl", "#7d3b0c"}, {"cid", "329"}, {"hgt", "155cm"}, {"eyr", "2030"},
                {"pid", "718399669"},
                {"iyr", "2011"}, {"ecl", "brn"},
            }),
            new Passport(new Dictionary<string, string> {
                {"cid", "147"}, {"eyr", "2021"}, {"hgt", "167cm"}, {"iyr", "2010"}, {"ecl", "grn"}, {"byr", "1975"},
                {"hcl", "#6b5442"},
                {"pid", "285479783"},
            }),
            new Passport(new Dictionary<string, string> {
